...
text_3 = '<ul style="font-family:sans-serif; color:#4d372c; font-size: 20px;"><ol><li>Assessing the direct impact of gas subsidies on transaction volumes across different types of activities (swaps, liquidity additions, and removals).</li><li>Examining changes in liquidity provider (LP) behavior in response to reduced transaction costs.</li><li>Conducting a comparative analysis of gas subsidy effects across various liquidity pool types.</li><li>Investigating user responses to high gas periods on L2s and identifying potential targeted subsidy strategies.</li></ol>'
